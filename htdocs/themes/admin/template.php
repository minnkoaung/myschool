        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown<?php echo (strstr(uri_string(), 'admin/properties')) ? ' active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button properties'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/properties') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/properties'); ?>"><?php echo lang('admin button proerties_list'); ?></a></li>
                             <li class="<?php echo (uri_string() == 'admin/locations') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/locations'); ?>"><?php echo lang('admin button locations_list'); ?></a></li>
                             <li class="<?php echo (uri_string() == 'admin/agents') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/agents'); ?>"><?php echo lang('admin button agents_list'); ?></a></li>
                            <li class="<?php echo (uri_string() == 'admin/properties/add') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/properties/add'); ?>"><?php echo lang('admin button properties_add'); ?></a></li>
                        </ul>
                    </li>
