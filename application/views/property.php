			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-9">
					<article class="post">
						...
						<div id="my-carousel" class="carousel slide">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img class="img-responsive" src="<?php echo base_url(); ?>/themes/<?php echo $this->settings->theme; ?>/assets/img/slide-1.jpg" alt="1200x500" >
								</div><!-- /.item -->
								<div class="item">
									<img class="img-responsive" src="<?php echo base_url(); ?>/themes/<?php echo $this->settings->theme; ?>/assets/img/slide-1.jpg" alt="1200x500" >
								</div><!-- /.item -->
						...
						<h2><i class="fa fa-map-marker"></i> <?php echo $property->address  ?>, <span class="text-muted"><?php echo $property->description  ?></span></h2>
							...
							<div class="col-sm-12 col-md-5">
								<div class="widget padding-md bg-secondary">
									...
									<ul class="list-unstyled">
										<li><i class="fa fa-fw fa-th"></i> <strong>Property:</strong> <?php echo $property->area  ?> Ft<sup>2</sup></li>
										<li><i class="fa fa-fw fa-calendar"></i> <strong>Year Built:</strong> 1890</li>
										<li><i class="fa fa-fw fa-columns"></i> <strong>Bedrooms:</strong> <?php echo $property->bedrooms  ?></li>
										<li><i class="fa fa-fw fa-female"></i> <strong>Bathrooms:</strong> <?php echo $property->bathrooms  ?></li>
							...
							<div class="col-sm-12 col-md-7">
								<div class="panel panel-secondary">
									...
									<div class="panel-body">
										<p>Come take a tour of a well maintained townhome in a wonderful location. Welcome to Grand Lagoon. This home offers a great floor plan with kitchen open to a spacious living room and dining area. Glass doors open to a private sitting area and patio.</p>
									</div><!-- /.panel-body -->
								</div><!-- /.panel -->
							...
							<div class="panel-body padding-md">
								<div class="row">
									<div class="col-sm-12 col-md-6">
										<h3>Agent details</h3>
										<div class="media">
											<a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url(); ?>/themes/<?php echo $this->settings->theme; ?>/assets/img/user-4.jpg" width="64" height="64" alt="64x64"></a>
