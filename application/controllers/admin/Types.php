...
class Types extends Admin_Controller {
    ...
    function __construct()
    {
        ...
        define('THIS_URL', base_url('admin/types'));
    ...
    function index()
    {
        ...
        // get list
        $types = $this->types_model->get_all($limit, $offset, $filters, $sort, $dir);

        // build pagination
        $this->pagination->initialize(array(
            'base_url'   => THIS_URL . "?sort={$sort}&dir={$dir}&limit={$limit}{$filter}",
            'total_rows' => $types['total'],
            'per_page'   => $limit
        ));
        ...
        // load views
        $data['content'] = $this->load->view('admin/types/list', $content_data, TRUE);
    ...
    function add()
    {
        ...
        if ($this->form_validation->run() == TRUE)
        {
            ...
            $saved = $this->types_model->create($types_data);
        ...
        // load views
        $data['content'] = $this->load->view('admin/types/form', $content_data, TRUE);
        $this->load->view($this->template, $data);
    }
    ...
    function edit($id = NULL)
    {
        ...
        if (TRUE)
        {
            ...
            $saved = $this->types_model->update($type_data,1);
    ...
    function delete($id = NULL)
    {
        ...
        if ( ! is_null($id) OR ! is_numeric($id))
        {
            ...
            if ($type)
            {
                ...
                $delete = $this->types_model->delete($id);
