...
class Properties extends Admin_Controller {
    ...
    function add()
    {
        ...
        $this->form_validation->set_rules('bathrooms', lang('users input bathrooms'), 'required|numeric');
    ...
    public function edit($id = NULL)
    {
        ...
        // get the data
        $properties = $this->properties_model->get($id);
        ...
        if (TRUE)
        {
            ...
            $saved = $this->properties_model->update($properties_data,1);
